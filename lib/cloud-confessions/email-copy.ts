...
export const cloudConfessionsEmails: CloudConfessionsEmailTemplate[] = [
  ...
  },
  {
    ...
    brevoListId: 14,
    trigger: "Automático 2 h después de quedar aprobado (lista 15)",
    timing: "2 horas después de la aprobación · tope 29 jul 12:00",
    stopConditions: [
    ...
    subject: "Pásanos un referido developer y te damos un obsequio",
    previewText:
      "Si conoces a un dev que pueda ser cliente de C4c7Ops, invítalo con tu link.",
    ctaLabel: "Abrir mi link",
    ctaUrl: cloudConfessionsEmailConfig.landingUrl,
    body: [
      "Hola {{ contact.NOMBRE }},",
      "Ya estás en Cloud & Coffee. Si conoces a un developer que pueda ser cliente de C4c7Ops, pásanos el referido.",
      "Invítalo con tu link. Si se registra, te damos un obsequio.",
      "Pásale este link o ábrelo y compártelo (el link lleva tu ?ref= personal).",
    ],
    notes: [
      "Referido = developer / posible cliente C4c7Ops.",
      "El código ?ref= atribuye el referido en la columna referido_por de Registros.",
      "Sale con el cron de la cola de correos, 2 h después de aprobar.",
    ],
  },
];
