...
export const cloudConfessionsEmails: CloudConfessionsEmailTemplate[] = [
  {
    ...
    subject: "Cloud & Coffee · tómate un café con nosotros",
    previewText: "Antes del Summit · 7:00 – 9:00 a. m. · cerca al Ágora.",
    ctaLabel: "Solicitar mi cupo",
    ctaUrl: cloudConfessionsEmailConfig.personalizedLandingUrl,
    body: [
      "Hola {{ contact.NOMBRE }},",
      "Antes del AWS Summit Bogotá queremos invitarte a Cloud & Coffee: un rato informal para tomarte un café con C4c7Ops y conversar sin agenda.",
      "Coffee · Conversations · Cloud.",
      "Será el jueves 30 de julio, cerca al Ágora, de 7:00 a. m. a 9:00 a. m. Llega cuando te quede bien dentro de esa franja. La dirección exacta te la compartimos al confirmar tu cupo.",
      "No es una conferencia ni tendrá presentaciones. Solo café, conversación y mejor energía para el Summit.",
  ...
  },
  {
    ...
    subject: "¿Te tomas un café con nosotros el 30?",
    previewText: "Cloud & Coffee · antes del Summit · cupos limitados.",
    ctaLabel: "Ver la invitación",
    ctaUrl: cloudConfessionsEmailConfig.personalizedLandingUrl,
    body: [
      "Hola {{ contact.NOMBRE }},",
      "Quizá se te pasó la invitación a Cloud & Coffee.",
      "Es un encuentro informal el jueves 30 de julio, cerca al Ágora: café, conversaciones y gente de cloud, de 7:00 a. m. a 9:00 a. m. Llega cuando te quede bien.",
  ...
  },
  {
    ...
    subject: "Último aviso: Cloud & Coffee",
    previewText: "Cupos limitados · 30 de julio · 7:00 – 9:00 a. m.",
    ctaLabel: "Solicitar mi cupo",
    ctaUrl: cloudConfessionsEmailConfig.personalizedLandingUrl,
    body: [
      "Hola {{ contact.NOMBRE }},",
      "Este es un último aviso para Cloud & Coffee.",
      "El jueves 30 de julio, cerca al Ágora, de 7:00 a. m. a 9:00 a. m.: café con nosotros y conversación antes del Summit. Llega cuando te acomode dentro de esa franja.",
  ...
  },
  {
    ...
    subject: "¿Terminamos tu solicitud para Cloud & Coffee?",
    previewText: "Entraste a la página · solo falta un paso.",
    ctaLabel: "Continuar mi solicitud",
    ctaUrl: cloudConfessionsEmailConfig.personalizedLandingUrl,
    body: [
      "Hola {{ contact.NOMBRE }},",
      "Vimos que entraste a la página de Cloud & Coffee.",
      "Si todavía quieres unirte el 30 de julio a tomarte un café con nosotros, solo falta completar la solicitud.",
  ...
  },
  {
    ...
    previewText: "Tu solicitud quedó a medias.",
  ...
  },
  {
    ...
    body: [
      ...
      "Será el jueves 30 de julio, cerca al Ágora, de 7:00 a. m. a 9:00 a. m. Llega cuando te quede bien dentro de esa franja. La dirección exacta se comparte si tu cupo es aprobado.",
  ...
  },
  {
    ...
    subject: "Tu cupo fue aprobado · Cloud & Coffee",
    ...
    body: [
      ...
      "Te esperamos el jueves 30 de julio en Antes, un café · Cl. 24d #40-34, Bogotá (cerca al Ágora), de 7:00 a. m. a 9:00 a. m. Llega cuando te quede bien dentro de esa franja.",
  ...
  },
  {
    ...
    previewText: "30 de julio · 7:00 – 9:00 a. m. · Antes, un café",
    ...
    body: [
      ...
      "Horario: 7:00 a. m. – 9:00 a. m. (llega cuando te quede bien)",
      "Lugar: Antes, un café · Cl. 24d #40-34, Bogotá",
      "Llega con tu QR. Café, conversación y luego el Summit.",
    ],
  },
  {
    id: "cc-reminder-2",
    ...
    subject: "Mañana nos vemos en Cloud & Coffee",
    previewText: "7:00 – 9:00 a. m. · Antes, un café · ten tu QR listo",
    ctaLabel: "Ver mi entrada",
    ctaUrl: "{{ contact.CC_EVENT_CHECKIN_URL }}",
    body: [
      "Hola {{ contact.NOMBRE }},",
      "Mañana es Cloud & Coffee.",
      "Nos vemos en Antes, un café · Cl. 24d #40-34, Bogotá, de 7:00 a. m. a 9:00 a. m. Llega cuando te quede bien dentro de esa franja.",
