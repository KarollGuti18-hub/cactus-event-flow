...
export const cloudConfessionsEmails: CloudConfessionsEmailTemplate[] = [
  ...
  },
  {
    ...
    body: [
      "Hola {{ contact.NOMBRE }},",
      "Ya estás en Cloud & Coffee. Si conoces a un developer de otra empresa que también va al Summit, invítalo.",
      "Si se registra con tu link, te regalamos una camiseta C4c7Ops.",
