...
export const cloudConfessionsEmails: CloudConfessionsEmailTemplate[] = [
  {
    ...
    previewText: "Antes del Summit · 7:00 a. m. – 9:00 a. m. · cerca al Ágora.",
    ...
    body: [
      ...
      "Será el jueves 30 de julio, entre 7:00 a. m. y 9:00 a. m., cerca al Ágora. La dirección exacta te la compartimos al confirmar tu cupo.",
      "No es una conferencia ni tendrá presentaciones. Solo pásate, tómate un café y llega al Summit con mejor energía.",
  ...
  },
  {
    ...
    body: [
      ...
      "Es un encuentro informal el jueves 30 de julio, entre 7:00 a. m. y 9:00 a. m., cerca al Ágora: café, conversaciones y gente de cloud antes del AWS Summit.",
  ...
  },
  {
    ...
    body: [
      ...
      "El jueves 30 de julio, entre 7:00 a. m. y 9:00 a. m., cerca al Ágora: pásate, tómate un café con nosotros y conversa antes del Summit.",
  ...
  },
  {
    ...
    body: [
      ...
      "Si todavía quieres pasar el 30 de julio a tomarte un café con nosotros, solo falta completar la solicitud.",
  ...
  },
  {
    ...
    body: [
      ...
      "Si quieres tu lugar el 30 de julio (7:00 a. m. – 9:00 a. m., cerca al Ágora), vuelve y termina el formulario.",
  ...
  },
  {
    ...
    body: [
      ...
      "Será el jueves 30 de julio, entre 7:00 a. m. y 9:00 a. m., cerca al Ágora. La dirección exacta se comparte si tu cupo es aprobado.",
  ...
  },
  {
    ...
    body: [
      ...
      "Te esperamos el jueves 30 de julio, entre 7:00 a. m. y 9:00 a. m., en Antes, un café · Cl. 24d #40-34, Bogotá (cerca al Ágora).",
  ...
  },
  {
    ...
    body: [
      ...
      "Nos vemos entre 7:00 a. m. y 9:00 a. m. en Antes, un café · Cl. 24d #40-34, Bogotá.",
